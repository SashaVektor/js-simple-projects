// Formulas from pounds to kilograms = x / 2.2046 grams = x / 0.0022046 ounces = x * 16
// Formulas from kilograms to pounds = x * 2.2046 grams = x * 1000 ounces = x * 35.274
// Formulas from grams to pounds = x * 0.0022046 kilograms = x / 1000 ounces = x * 0.035274
// Formulas from ounce to kilograms = x / 35.274 grams = x / 0.035274 pounds = x * 0.0625
